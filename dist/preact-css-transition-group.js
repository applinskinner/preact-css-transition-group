...
var CSSTransitionGroupChild = function (_Component) {
	...
	CSSTransitionGroupChild.prototype.render = function render() {
		return onlyChild(preact.toChildArray(this.props.children));
	};
...
var CSSTransitionGroup = function (_Component) {
	...
	function CSSTransitionGroup(props) {
		...
		_this.refs = {};
		_this.state = {
			children: (props.children ? preact.toChildArray(props.children) : []).slice()
		};
		return _this;
	}
	...
	CSSTransitionGroup.prototype.componentWillReceiveProps = function componentWillReceiveProps(_ref2) {
		...
		var nextChildMapping = filterNullChildren(children ? preact.toChildArray(children) : []).slice();

		var prevChildMapping = filterNullChildren(exclusive ? preact.toChildArray(this.props.children) : this.state.children);
	...
	CSSTransitionGroup.prototype._handleDoneEntering = function _handleDoneEntering(key) {
		...
		var currentChildMapping = filterNullChildren(preact.toChildArray(this.props.children)),
	...
	CSSTransitionGroup.prototype._handleDoneLeaving = function _handleDoneLeaving(key) {
		...
		var showProp = this.props.showProp,
		    currentChildMapping = filterNullChildren(preact.toChildArray(this.props.children));
	...
	CSSTransitionGroup.prototype.render = function render(_ref3, _ref4) {
		...
		return preact.h(
			Component,
			props,
			filterNullChildren(preact.toChildArray(children)).map(this.renderChild)
		);
	};
